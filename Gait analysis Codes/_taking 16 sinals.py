     ...
     for line in data:
         ...
         if len(linedata) >= 17:
             try:
                 ...
                 sig2.append(float(linedata[2]))
                 sig3.append(float(linedata[3]))
                 sig4.append(float(linedata[4]))
                 sig5.append(float(linedata[5]))
                 sig6.append(float(linedata[6]))
                 sig7.append(float(linedata[7]))
                 sig8.append(float(linedata[8]))
                 sig9.append(float(linedata[9]))
                 sig10.append(float(linedata[10]))
                 sig11.append(float(linedata[11]))
                 sig12.append(float(linedata[12]))
                 sig13.append(float(linedata[13]))
                 sig14.append(float(linedata[14]))
                 sig15.append(float(linedata[15]))
                 sig16.append(float(linedata[16]))
                 
             except ValueError as e:
                 print(f"Error processing line in file {filename}: {e}")

     tempsig = [sig1, sig2, sig3, sig4, sig5, sig6, sig7, sig8,sig9, sig10, sig11, sig12, sig13, sig14, sig15, sig16]
...
output_directory = r"D:\Newfolder\s7\project\spectrogram images\spect of 16 sig\spectrogram"
...
# Choose the output directory for saving spectrogram images
output_directory = r"D:\Newfolder\s7\project\spectrogram images\spect of 16 sig\spect resized"
...
original_directory = r"D:\Newfolder\s7\project\spectrogram images\spect of 16 sig\spect resized"

# Set the path to the resized images directory
resized_directory_224 = r"D:\Newfolder\s7\project\spectrogram images\spect of 16 sig\spec 224"
...
# Example usage
data_path = r"D:\Newfolder\s7\project\spectrogram images\spect of 16 sig\spec 224"
